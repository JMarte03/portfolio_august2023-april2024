...
-- Tiempo de generación: 03-08-2023 a las 03:18:32
...
(1, 'Juan Pérez', 'perez@gmail.com', '2023-08-02', 'Asunto pendiente', 'Esto es un asunto pendiente'),
(2, 'Roberto Torres', 'torres@gmail.com', '2023-08-02', 'Otro asunto', 'Esto es otro asunto pendiente'),
(9, 'José Casas', 'casas@gmail.com', '2023-08-03', 'Asunto pendiente', 'Esto es un otro asunto pendiente');
...
('MC2222', 'Silicon Valley Gastronomic Treats', 'Cooking', '0877', 20, 0, 2032, 'Favorite recipes for quick, easy, and elegant meals, tried and tested by people who never have time to eat, let alone cook.', '1989-06-09 12:00:00', '1'),
('MC3021', 'The Gourmet Microwave', 'Cooking', '0877', 2.99, 15000, 22246, 'Traditional French gourmet recipes adapted for modern microwave cooking.', '1985-06-18 12:00:00', '1'),
('MC3026', 'The Psychology of Computer Cooking', 'Technology', '0877', NULL, NULL, NULL, '', '2000-01-10 12:19:59', '0'),
('PC1035', 'But Is It User Friendly?', 'Technology', '1389', 23, 7000, 8780, 'A survey of software for the naive user, focusing on the \'friendliness\' of each.', '1986-06-30 12:00:00', '1'),
('PC8888', 'Secrets of Silicon Valley', 'Technology', '1389', 20, 8000, 4095, 'Muckraking reporting by two courageous women on the world\'s largest computer hardware and software manufacturers.', '1987-06-12 12:00:00', '1'),
('PC9999', 'Net Etiquette', 'Technology', '1389', NULL, NULL, NULL, 'A must-read for computer conferencing debutantes!', '2000-01-10 12:19:13', '0'),
...
('TC3218', 'Onions, Leeks, and Garlic: Cooking Secrets of the Mediterran', 'Cooking', '0877', 21, 7000, 375, 'Profusely illustrated in color, this makes a wonderful gift book for a cuisine-oriented friend.', '1990-10-21 12:00:00', '1'),
('TC4203', 'Fifty Years in Buckingham Palace Kitchens', 'Cooking', '0877', 12, 4000, 15096, 'More anecdotes from the Queen\'s favorite cook describing life among English royalty.  Recipes, techniques, tender vignettes.', '1985-06-12 12:00:00', '1'),
('TC7777', 'Sushi, Anyone?', 'Cooking', '0877', 15, 8000, 4095, 'Detailed instructions on improving your position in life by learning how to make authentic Japanese sushi in your spare time.  5-10% increase in number of friends per recipe reported from beta test.', '1987-06-12 12:00:00', '1');
